...
function TandC() {
  return (
    ...
    <div class="md:hidden w-full h-[63px] bg-[#FFFFFF] px-[17px] flex items-center">
        ...
        <p class="text-base font-semibold flex-1 -ml-[31.32px] text-center">Terms & Conditions</p>
    </div>
    <div class="w-full bg-neutral-100">
        <div class="container-lg md:pt-[80px] pb-[50px] md:pb-[100px] md:px-[112px] px-5 flex ">
            <div class="flex-1">
                <div>
                    <h1 class="font-semibold text-[20px] md:text-[30px] leading-[50px]">Terms & Conditions</h1>
