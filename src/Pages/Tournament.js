...
import cardBanner3 from '../assets/png/card-banner3.webp';
import cardBanner4 from '../assets/png/card-banner4.webp';
  ...
  return (
    ...
    <div className="max-md:hidden w-full flex justify-center items-center  h-[260px] bg-[#4267B333] ">
        <div className="w-full max-w-[500px]  text-center">
            <span className="text-[40px] font-semibold  text-black leading-[50px]">Tournament</span>
            <p className="leading-[26px] text-base  text-[#201E1ECC] mt-2.5">Sed
